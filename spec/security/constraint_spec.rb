...
describe Grant::Security::Constraint do
  ...
  describe 'permit?' do
    it 'should ignore actions it was not initialized for' do
      c = Grant::Security::Constraint.new(:create) { true }
    ...
    it 'should not allow association actions it was initialized to deny' do
      c = Grant::Security::Constraint.new(:create, :id) { false }
